  ...
  return (
    <div className="hud" style={{ ['--accent' as string]: colour }}>
      ...
      <header className="hud-top">
        {ui.chrome.brand && (
          <div className="brand">
            <span className="brand-mark">A.S.L.A.N.</span>
            <span className="brand-sub">Akıllı Sesli Lojik Asistan Nizamı</span>
          </div>
        )}
        ...
        <div className="log">
          <AnimatePresence initial={false}>
            {turns.slice(-4).map((t) => (
              ...
              >
                <span className="log-who">{t.role === 'user' ? 'YOU' : 'ASLAN'}</span>
      ...
      <footer className="hud-bottom">
        <span className="hint">
          say <b>“hey aslan”</b> · <kbd>Space</kbd> to talk · <kbd>G</kbd> hands
          {voice && (
            <>
              {' · '}
